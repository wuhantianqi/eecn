...
//  })
    jq('#new_base_info').click(function(){
    	if (validData()) {
	        ...
	        if(jq('#designPay del')[0]){
	        	jq('#designPay del').eq(0).html(mjia*0.19+'元')
	        }
	        else{
...
//	        jq('#designPay').append('<del>'+mjia*0.19+'元'+'</del>');
	        ...
	        if(jq('#qualityPay del')[0]){
	        	jq('#qualityPay del').eq(0).html(mjia*0.19+'元')
	        }
	        else{
	        	jq('#qualityPay').append('<del>'+mjia*0.19+'元'+'</del>')
	        }
