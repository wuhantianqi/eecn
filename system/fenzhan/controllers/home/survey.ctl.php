...
class Ctl_Home_Survey extends Ctl
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'fenzhan:home/survey/items.html';
    }

    public function so()
    {
        $this->tmpl = 'fenzhan:home/survey/so.html';
    }
    ...
    public function create()
    {
        if($this->checksubmit()){
           ...
           $this->tmpl = 'fenzhan:home/survey/create.html';
        }
    }
    ...
    public function edit($survey_id=null)
    {
        if(!($survey_id = (int)$survey_id) && !($survey_id = $this->GP('survey_id'))){
        	...
        	$this->tmpl = 'fenzhan:home/survey/edit.html';
        }
    }
