...
class Ctl_Home_Tuan extends Ctl
{
    public function index($page=1)
    {
        ...
        $this->tmpl = 'fenzhan:home/tuan/items.html';
    }

    public function so()
    {
        $this->tmpl = 'fenzhan:home/tuan/so.html';
    }
    ...
    public function create()
    {
        if($this->checksubmit()){
		   ...
		   $this->pagedata['city'] = $this->request['city'];
		   $this->tmpl = 'fenzhan:home/tuan/create.html';
        }
    }
    ...
    public function edit($tuan_id=null)
    {
        if(!($tuan_id = (int)$tuan_id) && !($tuan_id = $this->GP('tuan_id'))){
        	...
        	$this->tmpl = 'fenzhan:home/tuan/edit.html';
        }
    }
