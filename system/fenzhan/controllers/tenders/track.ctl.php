...
class Ctl_Tenders_Track extends Ctl
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'fenzhan:tenders/track/items.html';
    }

    public function so()
    {
        $this->tmpl = 'fenzhan:tenders/track/so.html';
    }
    ...
    public function detail($track_id = null)
    {
        if(!$track_id = (int)$track_id){
            ...
            $this->tmpl = 'fenzhan:tenders/track/detail.html';
        }
    }
    ...
    public function create($look_id=null)
    {
        if($data = $this->checksubmit('data')){
            ...
            $this->tmpl = 'fenzhan:tenders/track/create.html';
        }
    }
	...
	public function reply($track_id=null)
	{
		if(!($track_id = (int)$track_id) && !($track_id = $this->GP('track_id'))){
            ...
            $this->tmpl = 'fenzhan:tenders/track/reply.html';
        }
	}
    ...
    {
        if($track_id = (int)$track_id){
            if(!$detail = K::M('tenders/track')->detail($comment_id)){
