...
if(is_array($SO['dateline'])){if($SO['dateline'][0] && $SO['dateline'][1]){$a = strtotime($SO['dateline'][0]); $b = strtotime($SO['dateline'][1])+86400;$filter['dateline'] = $a."~".$b;}}
        ...
        $this->tmpl = 'fenzhan:tenders/log/items.html';
    }

    public function so()
    {
        $this->tmpl = 'fenzhan:tenders/log/so.html';
    }
    ...
    public function create()
    {
        if($this->checksubmit()){
           ...
           $this->tmpl = 'fenzhan:tenders/log/create.html';
        }
    }
    ...
    public function edit($log_id=null)
    {
        if(!($log_id = (int)$log_id) && !($log_id = $this->GP('log_id'))){
        	...
        	$this->tmpl = 'fenzhan:tenders/log/edit.html';
        }
    }
