...
class Ctl_Product_Product extends Ctl
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'fenzhan:product/product/items.html';
    }

    public function so()
    {
        $this->tmpl = 'fenzhan:product/product/so.html';
    }
    ...
    public function shop($shop_id=null)
    {
        if(!$shop_id = (int)$shop_id){
        ...
        }else if($shop['city_id'] != CITY_ID){
            $this->err->add('您没有权限', 213);
        }else{
            ...
            $this->tmpl = 'fenzhan:product/product/shop.html';
        } 
    }
    ...
    public function edit($product_id=null, $cat_id=null)
    {
        if(!($product_id = (int)$product_id) && !($product_id = $this->GP('product_id'))){
            ...
            $pager['type'] = 'edit';
            $this->pagedata['pager'] = $pager;
            $this->tmpl = 'fenzhan:product/product/select_cate.html';            
        }else{
        	...
        	$this->tmpl = 'fenzhan:product/product/edit.html';
        }
    }
