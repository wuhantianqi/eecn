...
class Ctl_Activity_Activity extends Ctl
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'fenzhan:activity/activity/items.html';
    ...
    public function so()
    {
        $this->tmpl = 'fenzhan:activity/activity/so.html';
    }
    ...
    {	
        ...
        if(!$activity_id = (int)$activity_id){
            ...
            $this->tmpl = 'fenzhan:activity/activity/detail.html';
        }
    }
	...
	public function create()
    {
        if($this->checksubmit()){
            ...
            $this->tmpl = 'fenzhan:activity/activity/create.html';
        }
    }
    ...
    public function edit($activity_id=null)
    {
        if(!($activity_id = (int)$activity_id) && !($activity_id = $this->GP('activity_id'))){
        	...
        	$this->pagedata['detail'] = $detail;
			$this->pagedata['cates'] = K::M('activity/cate')->fetch_all();
        	$this->tmpl = 'fenzhan:activity/activity/edit.html';
        }
    }
