...
class Ctl_Designer_Designer extends Ctl
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'fenzhan:designer/designer/items.html';
    }
    ...
    public function so($target=null, $multi=null)
    {
        ...
        $this->pagedata['pager'] = $pager;  
        $this->tmpl = 'fenzhan:designer/designer/so.html';
    }
    ...
    public function dialog($page=1)
    {
        ...
        $this->pagedata['items'] = $items;
        $this->pagedata['pager'] = $pager;
        $this->tmpl = 'fenzhan:designer/designer/dialog.html';      
    }
    ...
    public function edit($uid=null)
    {
        if(!($uid = (int)$uid) && !($uid = $this->GP('uid'))){
            ...
            $this->tmpl = 'fenzhan:designer/designer/edit.html';
        }
    }
